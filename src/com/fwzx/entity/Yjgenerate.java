...
public class Yjgenerate {
	...
	public static  List<Map<String, String>> two() {
		ApplicationContext aContext = new ClassPathXmlApplicationContext("myselfMain.xml");
    ...
    String[] aa = "ea35cc1f-4f75-4bcd-a428-158981695bd|d19521b22-028c-4324-9edb-5a7309ed718c".split("//|");
   ...
   for (int i = 0; i < aa.length; i++) {
	...
	public static  void html(String op) throws IOException {
		...
		File f_html = new File("D:/冀北电科院/预警/冀北.html");
