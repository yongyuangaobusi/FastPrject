...
(function(t, e) {
    ...
    t(document).mouseup(function() {
        e = !1
    }), t.widget("ui.legendmouse", {version: "1.10.4",options: {cancel: "input,textarea,button,select,option",distance: 1,delay: 0},_mouseInit: function() {
            var e = this;
...
//            if (!e) {
    ...
    var e = 5;
    t.widget("ui.legendslider", t.ui.legendmouse, {version: "1.10.4",widgetEventPrefix: "slide",options: {animate: !1,distance: 0,max: 100,min: 0,orientation: "horizontal",range: !1,step: 1,value: 0,values: null,change: null,slide: null,start: null,stop: null},_create: function() {
